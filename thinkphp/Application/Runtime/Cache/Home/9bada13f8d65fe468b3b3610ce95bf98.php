	...
	<div class="row">
		<div class="col-md-12 comment-div">
			...
			<?php if(($page) > "0"): ?><div class="mybutton">
					<?php $__FOR_START_9526__=0;$__FOR_END_9526__=$page;for($i=$__FOR_START_9526__;$i < $__FOR_END_9526__;$i+=1){ ?><button class="btn btn-default btn-page" id=<?php echo ($i); ?>><?php echo ($i+1); ?></button><?php } ?>			
				</div><?php endif; ?>
		</div>
		<div class="col-md-0">
