<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html><html><head> <title>xhust</title> <meta name="viewport" content="width=device-width, initial-scale=1"> <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no"> <link rel="shortcut icon" href="/xhust/thinkphp/Public/Apps/xhust.ico"></head><style type="text/css"> .my-container{ padding-top:5em; padding: 0 0.3em 0 0.3em; } .title{ border-radius: 10px; } .content{ margin-top:1em; background: white; padding: 0.5em; border-radius: 10px; margin-bottom: 1em; } .content img{ max-width: 100%; } .tail{ color: #639737; } .article-info{ height: 2em; } .article-info>span{ float: right; padding-right: 0.5em; color: #A8B1BA; }</style><script
