    ...
    <div <?php echo choose_class();?>>
        <div class="my-container">
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="title">
                         <h3><i class="fa fa-file-text fa-lg">&nbsp;</i><?php echo ($article[0]['title']); ?></h3>
                    </div>
                    <div class="content">
                        ...
                        <div class="article-info">
                            <span>
                                <i class="fa fa-eye fa-lg"></i>(<?php echo ($article[0]['read_times']); ?>)
                            </span>
                            <span>
                                <i class="fa fa-thumbs-o-up fa-lg"></i>
                                (<?php echo ($article[0]['love_times']); ?>)
                            </span>
                            
                            <span>
                            <i class="fa fa-clock-o fa-lg"></i> <?php echo date('Y-m-d',strtotime($article[0]['created_at']));?></span>
                            <span>
                    ...
                    <button id="<?php echo ($article[0]['id']); ?>" class="btn btn-success btn-love">这篇文章对我有用，我要点赞&nbsp;<i class="fa fa-thumbs-o-up fa-lg"></i>&nbsp;<span class="love_times"><?php echo ($article[0]['love_times']); ?></span></button>
                </div>
                <div class="col-md-4">
