...
</script></div></div></div></body><script type="text/javascript">jQuery(document).ready(function($) {$(".slippry-ppt").slippry();$(".slippry-two").particleground();$(".slippry-ppt>li").css("display","block");});$('.my-heart').click(function(event) {var url='<?php echo U("Home/Index/addHeart");?>';var appid=$(this).attr('id');$.post(url, {id: appid}, function(data, textStatus, xhr) {if(data['status']==1){$(".love_times[id="+appid+"]").text(data['data']);}});});var pt=$(".mynavdiv").height();$('.my-container').css('padding-top',pt);jQuery(document).ready(function($) {$(window).resize(function(event) {var pt=$(".mynavdiv").height();$('.my-container').css('padding-top',pt);});});</script></html>