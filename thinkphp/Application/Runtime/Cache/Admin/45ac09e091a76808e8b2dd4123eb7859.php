		...
		<div class="my-container">
			<table class="table table-striped">
				<tr>
					...
					<td>read_times</td>
					<td colspan="2">
						<button class="btn btn-success">发布新文章</button>
					</td>
				</tr>
				<?php if(is_array($article)): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						...
						<td>
							<span class="content">
							<?php echo (filter_content($vo["content"])); ?>
							</span>
						</td>
						...
						<td><?php echo ($vo["love_times"]); ?></td>
						<td>
							<a target="_blank" href="<?php echo U('Admin/Index/editcontent?id='.$vo['id']);?>">
