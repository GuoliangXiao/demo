		...
		<div class="my-container">			
			<div class="login">
				<div class="login-info">
					<h3>xhust login</h3>
					<hr>
					<form class="" method="post" action="<?php echo U('Admin/Index/login');?>">
					    <div class="input-group form-interval">
						    <span class="input-group-addon" id="sizing-addon1">用户名</span>
						    <input name="user" type="text" class="form-control" id="user" placeholder="user" aria-describedby="sizing-addon1">
						</div>
						<div class="input-group form-interval">
