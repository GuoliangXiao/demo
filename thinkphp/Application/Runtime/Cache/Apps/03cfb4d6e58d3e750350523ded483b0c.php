...
</script><body style="background: #eeeeee;"><style type="text/css">
	.mynavdiv{
		padding: 0;
		margin: 0;
	}
	...
	<div <?php echo choose_class();?>>
		<ul class="nav nav-tabs mynav">
		  	<li role="presentation" id="li-x"><a href="javascript:void(0);"><img src="/xhust/thinkphp/Public/Apps/xhust.ico"/></a></li>
	   		<li role="presentation"><a href='<?php echo U("Home/Index/index");?>'><span class="glyphicon glyphicon-home" aria-hidden="true"></span> &nbsp;首页</a></li>

		  	<li role="presentation"><a href="<?php echo U('Home/Index/index#my-blog-position');?>" target="_self"><span class="glyphicon glyphicon-flag" aria-hidden="true"></span> &nbsp;博客</a></li>
		</ul>
	</div>
</nav>
<div <?php echo choose_class();?>><div class="my-container">
<style type="text/css">
	.my-table{
	}
	td{
		...
		<div class="col-md-6">
			...
			<form class="form-inline" >
				<div class="form-group">
					<?php $__FOR_START_28870__=0;$__FOR_END_28870__=6;for($i=$__FOR_START_28870__;$i < $__FOR_END_28870__;$i+=1){ ?><label class="radio-inline">
		  		...
		  		<div class="form-group" >
            		<select name="normal_num" id="select-sys" class="form-control" disabled>
						<?php $__FOR_START_2183__=2;$__FOR_END_2183__=65;for($i=$__FOR_START_2183__;$i < $__FOR_END_2183__;$i+=1){ if($i!=2&&$i!=8&&$i!=10&&$i!=16){ echo '<option>'; echo $i.'进制'; echo '</option>'; } } ?>
					</select>
            	</div>
			</form>
		</div>
	...
	<div class="row my-row" >
		<div class="col-md-6 my-table">
			<table class="table">
				...
				<?php $__FOR_START_29620__=0;$__FOR_END_29620__=3;for($i=$__FOR_START_29620__;$i < $__FOR_END_29620__;$i+=1){ ?><tr class=<?php if($i%2) echo 'info';else echo 'warning';?>
					>
		...
		<div class="col-md-6 my-table">
			<table class="table">
				...
				<?php $__FOR_START_19421__=3;$__FOR_END_19421__=6;for($i=$__FOR_START_19421__;$i < $__FOR_END_19421__;$i+=1){ ?><tr class=<?php if($i%2) echo 'info';else echo 'warning';?>
					>
						<td style="vertical-align: middle;" width="50%">
							
							<?php if($i == 5): ?><div class="form-group" style="margin: 0;">
				            		<select name="normal_result" id="select-sys" class="form-control">
										<?php $__FOR_START_21330__=2;$__FOR_END_21330__=65;for($i=$__FOR_START_21330__;$i < $__FOR_END_21330__;$i+=1){ if($i!=2&&$i!=8&&$i!=10&&$i!=16){ echo '<option>'; echo $i.'进制'; echo '</option>'; } } ?>
									</select>
			            		</div>
