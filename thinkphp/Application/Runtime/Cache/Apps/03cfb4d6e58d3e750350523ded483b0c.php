		...
		<div class="col-md-6">
			...
			<form class="form-inline" >
				<div class="form-group">
					<?php $__FOR_START_3626__=0;$__FOR_END_3626__=6;for($i=$__FOR_START_3626__;$i < $__FOR_END_3626__;$i+=1){ ?><label class="radio-inline">
		  		...
		  		<div class="form-group" >
            		<select name="normal_num" id="select-sys" class="form-control" disabled>
						<?php $__FOR_START_1051__=2;$__FOR_END_1051__=65;for($i=$__FOR_START_1051__;$i < $__FOR_END_1051__;$i+=1){ if($i!=2&&$i!=8&&$i!=10&&$i!=16){ echo '<option>'; echo $i.'进制'; echo '</option>'; } } ?>
					</select>
            	</div>
			</form>
		</div>
	...
	<div class="row my-row" >
		<div class="col-md-6 my-table">
			<table class="table">
				...
				<?php $__FOR_START_10680__=0;$__FOR_END_10680__=3;for($i=$__FOR_START_10680__;$i < $__FOR_END_10680__;$i+=1){ ?><tr class=<?php if($i%2) echo 'info';else echo 'warning';?>
					>
		...
		<div class="col-md-6 my-table">
			<table class="table">
				...
				<?php $__FOR_START_913__=3;$__FOR_END_913__=6;for($i=$__FOR_START_913__;$i < $__FOR_END_913__;$i+=1){ ?><tr class=<?php if($i%2) echo 'info';else echo 'warning';?>
					>
						<td style="vertical-align: middle;" width="50%">
							
							<?php if($i == 5): ?><div class="form-group" style="margin: 0;">
				            		<select name="normal_result" id="select-sys" class="form-control">
										<?php $__FOR_START_25334__=2;$__FOR_END_25334__=65;for($i=$__FOR_START_25334__;$i < $__FOR_END_25334__;$i+=1){ if($i!=2&&$i!=8&&$i!=10&&$i!=16){ echo '<option>'; echo $i.'进制'; echo '</option>'; } } ?>
									</select>
			            		</div>
