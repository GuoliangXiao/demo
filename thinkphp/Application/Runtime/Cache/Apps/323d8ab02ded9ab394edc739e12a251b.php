...
<div class="row">
	<div class="col-md-6">
		...
		<div class="weather-next">
			<ul>
				<?php $__FOR_START_1411__=1;$__FOR_END_1411__=5;for($i=$__FOR_START_1411__;$i < $__FOR_END_1411__;$i+=1){ ?><li class="weather-forecast-info">
			...
			<div class="col-md-10 div-aqi-2">
				<div class="aqi-info">
					...
					<div class="aqi-standart">
						<?php $__FOR_START_29440__=0;$__FOR_END_29440__=6;for($i=$__FOR_START_29440__;$i < $__FOR_END_29440__;$i+=1){ ?><div style="display:inline-block; width: 16.66%;height: 1.5em;text-align: center;line-height: 1.5em;color: white;"></div><?php } ?>
					</div>
				</div>
			</div>
		</div>
